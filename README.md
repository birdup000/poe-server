...
We do not endorse or promote the use of the server or API in any way that violates the TOS. If you use the server or API in a way that violates the TOS, you may be subject to disciplinary action by the developers at poe.com .This may include, but is not limited to, loss of your account or proxy provider.
